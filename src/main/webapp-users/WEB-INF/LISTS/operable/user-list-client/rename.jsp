...
<form name='users_list_form_update' id='users_list_form_rename'>
	<table>
		...
		<tr>
			...
			<td><input type='password' id='users_list_form_rename_password'/></td>
		</tr>
		<tr>
	...
	<br>
	<input type='button' value='Потврда операције' onclick='user_list_rename_client("${pageContext.request.contextPath}")'/>
</form>